	...
	return (
		<div className="info-container">
			<div className="info-box">
				<Icon className="icon" icon="material-symbols:calendar-today-rounded" width="60" height="60" />
				<div className="info-desc-header">Date and Time</div>
				<div className="info-desc">Sat, Mar 25, 2023, 8:00 AM EDT<br />&nbsp;</div>
			</div>
			<div className="info-box">
				<Icon className="icon"
					icon="material-symbols:person-pin-circle" width="60" height="60" />
				<div className="info-desc-header">Location</div>
				<div className="info-desc">Cedar Creek WMA Check Station<br />Checking Station Road Southwest<br />Eatonton, GA 31024</div>
			</div>
		</div>
	)
}